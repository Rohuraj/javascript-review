      ...
      var arr2=["name",12,true];
       console.log(arr2);
        //array storing list of arrays
         var arr3=[[1,2],[2,3],[3,4]]; console.log(arr3);
...
//for((intialization expression,);(conditioinal expression);(incremental expression)){}
//switch(var name){
//case1:statement}
//break;
//case2:statement
...
// databases concept _ ref,on,reading data,writing data
